...
execute if entity @s[advancements={filched:aspect_encyclopedia/summon_aspect_picker=true}] run advancement revoke @s only filched:aspect_encyclopedia/summon_aspect_picker
...
item modify entity @n[type=minecraft:armor_stand, tag=aspect_picker_granter, distance=..4] weapon.mainhand filched:aspect_picker
