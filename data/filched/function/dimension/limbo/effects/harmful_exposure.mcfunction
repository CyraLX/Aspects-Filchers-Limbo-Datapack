...
execute positioned ~-8 ~-13 ~-8 unless entity @n[dx=14.75, dy=13.1, dz=14.75, type=minecraft:armor_stand, tag=filcher_anchor] run return run function filched:dimension/limbo/effects/harmful/damage
