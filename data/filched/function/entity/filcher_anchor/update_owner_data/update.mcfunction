...
# Log data missmatch
data modify storage aspectlib:dummy filcher_anchor_owner set from entity @n[type=minecraft:armor_stand, tag=filched.filcher_anchor.owner_checker] data.filched.filcher_anchor.owner
...
execute if entity @p[tag=aspectlib.receive_logs_expanded] run tellraw @a[tag=aspectlib.receive_logs_expanded] {translate: "OLD: {name: %s, id: %s, UUID: %s, name_changes: %s}", "color":"#aaaaaa", "with": [{"storage":"aspectlib:dummy", "nbt": "filcher_anchor_owner.name","color":"gold"}, {"storage":"aspectlib:dummy", "nbt": "filcher_anchor_owner.id","color":"gold"}, {"storage":"aspectlib:dummy", "nbt": "filcher_anchor_owner.UUID","color":"gold"}, {"storage":"aspectlib:dummy", "nbt": "filcher_anchor_owner.name_changes","color":"gold"}]}
