...
execute if entity @p[tag=aspectlib.receive_logs_expanded] run tellraw @a[tag=aspectlib.receive_logs_expanded] {translate: "OLD: {name: %s, id: %s, UUID: %s, name_changes: %s}", "color":"#aaaaaa", "with": [{"storage":"aspectlib:cache", "nbt": "temp.filcher_anchor_owner.name","color":"gold"}, {"storage":"aspectlib:cache", "nbt": "temp.filcher_anchor_owner.id","color":"gold"}, {"storage":"aspectlib:cache", "nbt": "temp.filcher_anchor_owner.UUID","color":"gold"}, {"storage":"aspectlib:cache", "nbt": "temp.filcher_anchor_owner.name_changes","color":"gold"}]}
