...
function filched:focus/filcher/normal/store_player_location with storage aspectlib:dummy
...
execute unless data storage aspectlib:dummy filcher_anchor_pos_x run return run function filched:focus/filcher/normal/anchor/missing
# Otherwise continue normal teleport logic
function filched:focus/filcher/normal/anchor/found