...
# Update pack format (currently unused, for future proofing)
data modify entity @s data.filched.pack_format.previous set from entity @s data.filched.pack_format.current
