...
data modify storage aspects:aspect_list filched:filcher set value {id: 895998, namespace: "filched", name: "filcher", color: "#8b7e77", sound: "minecraft:block.sculk.break"}
